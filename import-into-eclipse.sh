...
COMMAND="/Users/pengwei/gradle/gradle-3.4/bin/gradle --no-daemon cleanEclipse :spring-oxm:compileTestJava eclipse -x :eclipse"
...
COMMAND="/Users/pengwei/gradle/gradle-3.4/bin/gradle --no-daemon :eclipse"
