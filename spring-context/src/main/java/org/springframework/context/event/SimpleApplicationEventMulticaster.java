...
public class SimpleApplicationEventMulticaster extends AbstractApplicationEventMulticaster {
	 ...
	 * @since 4.1
	 */
	// SpringApplication#run方法中的调用finished方法时，会设置 errorHandler
	...
	protected void invokeListener(ApplicationListener<?> listener, ApplicationEvent event) {
		// 当ErrorHandler不为null时,当调⽤doInvokeListener出现异常时,会交由ErrorHandler进⾏处理.
	...
	private void doInvokeListener(ApplicationListener listener, ApplicationEvent event) {
		try {
			// 对于LoggingApplicationListener,会调⽤LoggingApplicationListener#onApplicationStartingEvent⽅法.
